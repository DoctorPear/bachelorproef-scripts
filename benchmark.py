...
class Producer(threading.Thread):
    ...
    def run(self):
        producer = KafkaProducer(bootstrap_servers='b-1.testtt.3v7g9x.c1.kafka.eu-west-1.amazonaws.com:9092')
        self.sent = 0
...
class Consumer(threading.Thread):
    ...
    def run(self):
        consumer = KafkaConsumer(bootstrap_servers='b-1.testtt.3v7g9x.c1.kafka.eu-west-1.amazonaws.com:9092',
